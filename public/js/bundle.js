...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWFzaW5zZXJiZXN0IiwiYSI6ImNreWZzendxMjByZngyb3FwZDM0OG0yMTUifQ.lpY8WiPVqE6mOswQIECFCA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yasinserbest/ckyfwf3rn8sfc16n2x5pg5je0/draft',
    // style URL
...
stripe = Stripe(
  'pk_test_51KNWsOLm8nGo9M8uLoY1Y2KwUjJgV10ZnCZfiw16FnPN3GJkCqgVyunnCytUYBJ9Qa1u0zuIPSKfKbjQC6Z6IeZp000k07rG9Z'
);

export const bookTour = async (tourId) => {
  try {
    // 1) Get checkout session from API
    const session = axios(`/api/v1/booking/checkout-session/${tourId}`);
    console.log(session);
...
if (userDataForm) //kullanıcının bilgilerini güncellemesi
