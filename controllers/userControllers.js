...
const filterObj = (obj, ...allowedFields) => {
  //bu fonksiyonu user kendini update ederken update edebileceği alanları belirtmek için yazdık. mesela allowerdFields kısmına name,email,image falan yazıcaz, role yazmıcaz mesela
  const newObj = {};
